		...
		<header id="masthead"> <!-- HEADER -->
			<div class="">
				<div class="row">
					<div class="col-lg-12">
						<div>
							<nav id="beepo-top-main-menu" class="navbar navbar-expand-lg navbar-light">
								<div class="navbar-brand" href="#">
									<ul id="beepo-logo-main-container" class="no-padding-list-start">
										<li>
										  	<div id="beepo-top-logo-container">
												<a href="<?php echo get_site_url(); ?>">
													<img src="<?php echo get_template_directory_uri(); ?>/images/Beepo-main-logo.png" id="beepo-top-logo" class="img-fluid" alt="
Beepo outsourcing registered trademark logo">
												</a>
											</div>													
										</li>
										<li>
											<?php dynamic_sidebar( 'careers_page_header_contact_info' ); ?>
										</li>
									</ul>		
								</div>
