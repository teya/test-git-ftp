<?php
/**
 * Template Name: Free Live Webinar Template
 *
 * @package WordPress
...
<div class="beepo-career-page-container" id="webinar-beepo-career-page-container">
                    ...
                    <div class="header-main-title-container">
                        <div class="header-page-title-wrapper">
                            <div class="page-header section-header">
                                <h1>
                                    <div class="webinar-page-title">FREE LIVE WEBINAR<br><span>HOW TO OPTIMISE YOUR IT WORK FROM HOME SET UP DURING COVID-19</span></div>
                                </h1>
                            </div>
