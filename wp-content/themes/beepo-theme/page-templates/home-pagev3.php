					...
					<div class="col-lg-12">
						...
						<div class="clearfix homepage-searchbox-container" id="search-you-job-form-container">
							...
							<div id="search-you-job-form-wrapper">
								...
								<form id="search-you-job-form" action="<?php echo $_SERVER['PHP_SELF']; ?>/find-your-dream-job">

										<input class="search-you-job-form-input-text" type="text" name="ja-keywords" placeholder="Search for jobs here">

										<input class="search-you-job-form-input-submit" type="submit" value="GO >">

								</form>						

							</div> <!-- search-you-job-form-container -->
